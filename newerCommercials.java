...
//        long startTime = System.currentTimeMillis();
        ...
        int resultTotal = 0;
        int lowestIndex = findLowestIndex(profitTotals);
        for (int i = lowestIndex + 1; i <= findHighestIndex(profitTotals, lowestIndex + 1); i++){
...
//        System.out.println("Total time: " + (endTime - startTime));
    ...
    public static int findHighestIndex(int[] inList, int startVal){
        int indexHighest = -1;
        int highestVal = -1000;
        for (int i = startVal; i < inList.length; i++){
